...
.header {
  padding: 10px;
  background-image:url("https://user-images.githubusercontent.com/5901923/47139414-1272d400-d2bc-11e8-9ac4-d14c660e2376.jpg"); 
  height: 800px;
color:white;
}
...
.header3 {
  ...
  top:1500px;
  height: 1400px;
  background: linear-gradient(0deg, #001122 0%, #015C78 0.01%, #012A38 100%);
}
...
<h1 style="transform: rotate(-90deg); left: 0.20px; position: absolute; top: 2000px">NUR-SULTAN</h1>
 <div class="column middle5" >
  ...
  <br>
  <br>
  <button class="accordion">Время : 10:30 -12:00 </button>
